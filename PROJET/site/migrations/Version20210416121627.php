 ...
 */
final class Version20210416121627 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Im2021_Produits (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_pk INTEGER DEFAULT NULL, libelle VARCHAR(64) NOT NULL COLLATE BINARY, prix INTEGER NOT NULL, quantity INTEGER DEFAULT NULL, CONSTRAINT FK_5BD40928ACD1671C FOREIGN KEY (user_pk) REFERENCES Im2021_Utilisateurs (pk) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__Im2021_Utilisateurs AS SELECT pk, identifiant, motdepasse, nom, prenom, isadmin, anniversaire FROM Im2021_Utilisateurs');
        ...
        $this->addSql('INSERT INTO Im2021_Utilisateurs (pk, identifiant, motdepasse, nom, prenom, isadmin, anniversaire) SELECT pk, identifiant, motdepasse, nom, prenom, isadmin, anniversaire FROM __temp__Im2021_Utilisateurs');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , nom VARCHAR(30) DEFAULT NULL, prenom VARCHAR(30) DEFAULT NULL, isadmin INTEGER DEFAULT 0 NOT NULL, anniversaire DATE DEFAULT NULL, motdepasse VARCHAR(64) NOT NULL COLLATE BINARY --mot de passe crypté : il fuat une taille assez grande pour ne pas le tronquer
        )');
        $this->addSql('INSERT INTO Im2021_Utilisateurs (pk, identifiant, motdepasse, nom, prenom, isadmin, anniversaire) SELECT pk, identifiant, motdepasse, nom, prenom, isadmin, anniversaire FROM __temp__Im2021_Utilisateurs');
        $this->addSql('DROP TABLE __temp__Im2021_Utilisateurs');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1768BA8DC90409EC ON Im2021_Utilisateurs (identifiant)');
