 ...
 */
final class Version20210416113952 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , nom VARCHAR(30) DEFAULT NULL COLLATE BINARY, prenom VARCHAR(30) DEFAULT NULL COLLATE BINARY, isadmin INTEGER DEFAULT 0 NOT NULL, anniversaire DATETIME DEFAULT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , nom VARCHAR(30) DEFAULT NULL, prenom VARCHAR(30) DEFAULT NULL, isadmin INTEGER DEFAULT 0 NOT NULL, anniversaire DATE DEFAULT NULL)');
