 ...
 */
final class Version20210416102856 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , nom VARCHAR(30) DEFAULT NULL COLLATE BINARY, prenom VARCHAR(30) DEFAULT NULL COLLATE BINARY, anniversaire DATETIME DEFAULT NULL, isadmin INTEGER DEFAULT 0 NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , nom VARCHAR(30) DEFAULT NULL, prenom VARCHAR(30) DEFAULT NULL, anniversaire DATETIME DEFAULT NULL, isadmin SMALLINT DEFAULT 0 NOT NULL)');
