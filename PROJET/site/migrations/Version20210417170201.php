 ...
 */
final class Version20210417170201 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_95FB4B4CCD11A2CF');
        $this->addSql('DROP INDEX IDX_95FB4B4CACD1671C');
        $this->addSql('CREATE TEMPORARY TABLE __temp__Im2021_Panier AS SELECT id, user_pk, produits_id, quantite FROM Im2021_Panier');
        ...
        $this->addSql('INSERT INTO Im2021_Panier (id, user_pk, produit_id, quantite) SELECT id, user_pk, produits_id, quantite FROM __temp__Im2021_Panier');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE Im2021_Panier');
        $this->addSql('CREATE TABLE Im2021_Panier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_pk INTEGER DEFAULT NULL, quantite INTEGER NOT NULL, produits_id INTEGER DEFAULT NULL, produit INTEGER NOT NULL)');
        $this->addSql('INSERT INTO Im2021_Panier (id, user_pk, produits_id, quantite) SELECT id, user_pk, produit_id, quantite FROM __temp__Im2021_Panier');
        $this->addSql('DROP TABLE __temp__Im2021_Panier');
        $this->addSql('CREATE INDEX IDX_95FB4B4CACD1671C ON Im2021_Panier (user_pk)');
        $this->addSql('CREATE INDEX IDX_95FB4B4CCD11A2CF ON Im2021_Panier (produits_id)');
    }
}
