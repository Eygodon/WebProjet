 ...
 */
final class Version20210416094924 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , nom VARCHAR(30) DEFAULT NULL COLLATE BINARY, prenom VARCHAR(30) DEFAULT NULL COLLATE BINARY, isadmin SMALLINT DEFAULT 0 NOT NULL, anniversaire DATETIME DEFAULT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , nom VARCHAR(30) DEFAULT NULL, prenom VARCHAR(30) DEFAULT NULL, isadmin SMALLINT DEFAULT 0 NOT NULL, anniversaire DATE DEFAULT NULL)');
        $this->addSql('INSERT INTO Im2021_Utilisateurs (pk, identifiant, motdepasse, nom, prenom, anniversaire, isadmin) SELECT pk, identifiant, motdepasse, nom, prenom, anniversaire, isadmin FROM __temp__Im2021_Utilisateurs');
        $this->addSql('DROP TABLE __temp__Im2021_Utilisateurs');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1768BA8DC90409EC ON Im2021_Utilisateurs (identifiant)');
    }
