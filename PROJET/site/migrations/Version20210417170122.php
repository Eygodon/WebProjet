 ...
 */
final class Version20210417170122 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Im2021_Panier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_pk INTEGER DEFAULT NULL, produits_id INTEGER DEFAULT NULL, produit INTEGER NOT NULL, quantite INTEGER NOT NULL, CONSTRAINT FK_95FB4B4CACD1671C FOREIGN KEY (user_pk) REFERENCES Im2021_Utilisateurs (pk) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_95FB4B4CCD11A2CF FOREIGN KEY (produits_id) REFERENCES Im2021_Produits (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
